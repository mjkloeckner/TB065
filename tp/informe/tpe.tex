...
\href{mailto:pmartinezm@fi.uba.ar}{pmartinezm@fi.uba.ar}\\
...
\subsection{Obtención y Gráfico de
...
\PY{n}{urlretrieve}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{https://github.com/mjkloeckner/TB065/raw/main/tp/data/picasso\PYZus{}short.wav}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{short\PYZus{}sample\PYZus{}file\PYZus{}name}\PY{p}{)}\PY{p}{;}
\PY{n}{urlretrieve}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{https://github.com/mjkloeckner/TB065/raw/main/tp/data/picasso\PYZus{}long.wav}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{long\PYZus{}sample\PYZus{}file\PYZus{}name}\PY{p}{)}\PY{p}{;}
\end{Verbatim}
\end{tcolorbox}
...
\end{tcolorbox}
    ...
    \vspace{-0.50em}
    \begin{center}
    \adjustimage{max size={\linewidth}{\paperheight}}{tpe_files/tpe_15_0.png}
    \end{center}
    { \hspace*{\fill} \\}
    \vspace{-2.75em}
...
\end{tcolorbox}
    ...
    \vspace{-0.50em}
    \begin{center}
    \adjustimage{max size={\linewidth}{\paperheight}}{tpe_files/tpe_17_0.png}
    \end{center}
    { \hspace*{\fill} \\}
    \vspace{-2.75em}
...
\end{tcolorbox}
    ...
    \vspace{-0.50em}
    \begin{center}
    \adjustimage{max size={\linewidth}{\paperheight}}{tpe_files/tpe_20_0.png}
    \end{center}
    { \hspace*{\fill} \\}
    \vspace{-2.75em}
...
\end{tcolorbox}
    ...
    \vspace{-0.50em}
    \begin{center}
    \adjustimage{max size={\linewidth}{\paperheight}}{tpe_files/tpe_22_0.png}
    \end{center}
    { \hspace*{\fill} \\}
    \vspace{-2.75em}
...
\end{tcolorbox}
    ...
    \vspace{-0.50em}
    \begin{center}
    \adjustimage{max size={\linewidth}{\paperheight}}{tpe_files/tpe_24_0.png}
    \end{center}
    { \hspace*{\fill} \\}
    \vspace{-2.75em}
...
\end{tcolorbox}
    ...
    \vspace{-0.50em}
    \begin{center}
    \adjustimage{max size={\linewidth}{\paperheight}}{tpe_files/tpe_26_0.png}
    \end{center}
    { \hspace*{\fill} \\}
    \vspace{-2.75em}
...
\end{tcolorbox}
    ...
    \vspace{-0.50em}
    \begin{center}
    \adjustimage{max size={\linewidth}{\paperheight}}{tpe_files/tpe_28_0.png}
    \end{center}
    { \hspace*{\fill} \\}
    \vspace{-2.75em}
...
\end{tcolorbox}
    ...
    \vspace{-0.50em}
    \begin{center}
    \adjustimage{max size={\linewidth}{\paperheight}}{tpe_files/tpe_33_0.png}
    \end{center}
    { \hspace*{\fill} \\}
    \vspace{-2.75em}
...
\end{tcolorbox}
    ...
    \vspace{-0.50em}
    \begin{center}
    \adjustimage{max size={\linewidth}{\paperheight}}{tpe_files/tpe_35_0.png}
    \end{center}
    { \hspace*{\fill} \\}
    \vspace{-2.75em}
...
\end{tcolorbox}
    ...
    \vspace{-0.50em}
    \begin{center}
    \adjustimage{max size={\linewidth}{\paperheight}}{tpe_files/tpe_37_0.png}
    \end{center}
    { \hspace*{\fill} \\}
    \vspace{-2.75em}
...
\end{tcolorbox}
    ...
    \vspace{-0.50em}
    \begin{center}
    \adjustimage{max size={\linewidth}{\paperheight}}{tpe_files/tpe_39_0.png}
    \end{center}
    { \hspace*{\fill} \\}
    \vspace{-2.75em}
...
\end{tcolorbox}
    ...
    \vspace{-0.50em}
    \begin{center}
    \adjustimage{max size={\linewidth}{\paperheight}}{tpe_files/tpe_41_0.png}
    \end{center}
    { \hspace*{\fill} \\}
    \vspace{-2.75em}
...
\end{tcolorbox}
    ...
    \vspace{-0.50em}
    \begin{center}
    \adjustimage{max size={\linewidth}{\paperheight}}{tpe_files/tpe_43_0.png}
    \end{center}
    { \hspace*{\fill} \\}
    \vspace{-2.75em}
